...
## INCOMPLETE_CHANGES
- P0-001~006/P1-001/P1-002/P1-003/P2-001 are verified. P2-002 is starting; no partial P2-002 code yet.
...
## NEXT_EXACT_STEPS
1. P2-002: define the transient raw-input to structured-feature normalization boundary and feature-only reconstruction contract; do not store reconstructable source text.
2. Keep paid LLM/provider calls disabled; use deterministic local contracts and privacy regression fixtures.
3. Advance to P2-003 only after normal/no-case and risk/case paths have privacy and API coverage.
