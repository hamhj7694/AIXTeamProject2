...
const Workspace: React.FC = () => {
  ...
  return <div className="app-shell">
    ...
    <div className="workspace-body">
      ...
      <div className="workspace-main"><Routes><Route path="/" element={<HomePage/>}/><Route path="/cases/:caseId" element={<CaseRoomPage onMutated={() => void loadCases()} contextOpen={contextOpen} onContextOpenChange={setContextOpen}/>}/><Route path="*" element={<Navigate to="/" replace/>}/></Routes></div>
    </div>
  </div>;
};
