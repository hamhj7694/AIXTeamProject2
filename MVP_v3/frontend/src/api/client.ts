...
export const errorMessage = (payload: unknown, status: number) => {
  const codes: Record<string, string> = {
    ...
    CURRENT_USER_CANNOT_BE_REMOVED: '현재 기능 체험자는 케이스 담당자에서 제거할 수 없습니다.',
    CASE_OWNER_CANNOT_BE_REMOVED: '사건 총괄은 새 총괄을 지정한 후 제거할 수 있습니다.',
    CASE_MEMBER_NOT_FOUND: '케이스 담당자를 찾을 수 없습니다.',
