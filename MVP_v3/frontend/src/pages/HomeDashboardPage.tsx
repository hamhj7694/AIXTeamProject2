...
const CaseBoardIntro: React.FC = () => <div className="home-board-intro">
  <p className="eyebrow">CSR | Case Share Room</p>
  ...
  return <section className="home-empty home-board-page">
    <header className="home-case-board-header">
      ...
      <div className="home-board-actions">
        <button className="start-analysis-button" type="button" onClick={() => setAnalysisOpen(true)}><FileSearch size={16}/>새 통화 분석하기</button>
        <button className="bank-staff-open-button" type="button" onClick={() => setBankStaffOpen(true)}>은행 담당자 관리</button>
      </div>
