...
async def readiness() -> dict[str, object]:
    ...
    return {
        ...
        "diagnosis_limits": {
            "max_calls": int(os.getenv("OPENAI_MAX_CALLS_PER_DIAGNOSIS", "256")),
            "max_total_tokens": int(os.getenv("OPENAI_MAX_TOTAL_TOKENS_PER_DIAGNOSIS", "512000")),
            "max_input_chars": int(os.getenv("DIAGNOSIS_MAX_INPUT_CHARS", "100000")),
            "max_turns": int(os.getenv("DIAGNOSIS_MAX_TURNS", "180")),
