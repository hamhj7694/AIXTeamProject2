...
- [x] 현재 Quality / Grounding / Fact 반영 흐름 READ-ONLY 확인
- [x] 2-1 설명형 AI_RESPONSE 처리 방향 확정 및 구현
- [x] 2-2 직원 확인 사실의 `CONFIRMED` 반영 흐름 확정 및 구현
...
- [x] 현재 질문 / 답변 렌더링 흐름 READ-ONLY 확인
- [x] UI 변경 방향 확정
- [ ] 구현 완료
...
상태: `IN_PROGRESS` — 발송 batch 식별자가 없어 발송 후 묶음 표시는 보류
...
Bank AI 응답에서 현재 내용을 빠르게 파악할 수 있는 핵심 정리 또는 다음 확인 포인트를 제공합니다.

- [x] 현재 출력 구조 확인 및 표현 형식 확정
- [x] 구현 완료
- [ ] Runtime / Browser 검증
- [ ] 관련 문서 갱신
...
- [x] Bank AI와 기존 질문 기능 연결 구조 READ-ONLY 확인
- [x] 기존 추천 질문 로직 재사용 방식 확정
- [x] 기능 연동 구현
- [ ] Runtime / Browser 검증
- [ ] 관련 문서 갱신
