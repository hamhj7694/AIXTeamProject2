...
- [x] 마감-1 초기 참여 등록 순서와 역할 변경 후 버튼 권한 갱신; 명시적 시연 검토자 설정
- [x] 마감-2 같은 사건·공개 범위로 제한한 한국어 문구/동의어 RAG → 은행/고객 AI 연결
- [x] 마감-3 새 직원 사실·업무·결정 → 은행 AI·업무 카드·최종 보고서 입력 연결
- [x] 마감-4 General 132 / AI 89 / Frontend 34 검사 및 production build
- [x] 마감-5 서버 3개 HTTP 200, 실제 DB 검색 후 AI 1회 응답; 사건 쓰기 없음
- [ ] 마감-6 실제 브라우저에서 역할 선택·버튼 클릭·저장·새로고침 유지 검증 (브라우저 연결 필요)
