...
@app.post(
    "/ai/case-support/snapshot",
    response_model=CaseSnapshotPresentationFixture,
)
async def build_case_support_snapshot(
    request: CaseSnapshotAiInput,
) -> CaseSnapshotPresentationFixture:
    """기존 진단 결과를 담당자 검토용 Brief·질문 후보로 변환하는 내부 API."""
    try:
